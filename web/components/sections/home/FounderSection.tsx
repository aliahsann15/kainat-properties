...
function FounderSection() {
  return (
    <section className="bg-kp-rose-quartz py-24 md:py-32" id="about">
      <div className="mx-auto grid w-[min(100%_-_48px,1320px)] grid-cols-12 items-center gap-10">
        ...
        <div className="col-span-6 col-start-7 max-[900px]:col-span-12">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a className="kp-button kp-button-primary" href="#about">
              Learn More About Kainat
            </a>
            <a className="kp-button kp-button-secondary" href="#social">
              Follow on Instagram
            </a>
          </div>
        </div>
